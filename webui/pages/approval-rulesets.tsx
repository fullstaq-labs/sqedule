...
function CreationDialogContents(props: any): JSX.Element {
  return (
    <>
      <DialogTitle id="creation-dialog-title">Create approval ruleset</DialogTitle>
      <DialogContent id="creation-dialog-description">
        <Typography variant="body1">
          ...
          <p>
            To learn about all possible options, run <CodeSpan>sqedule approval-ruleset create --help</CodeSpan>
          </p>

          <h4>Step 2: bind to an application</h4>
          <p>Run:</p>
          <CodeBlock>
            sqedule application-approval-ruleset-binding create \{"\n"}
            {' '} --application-id {'<ID>'} \{"\n"}
            {' '} --approval-ruleset-id {'<ID>'} \{"\n"}
